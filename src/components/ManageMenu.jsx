...
export default function ManageMenu({ sessionId, menuItems, onRefresh, onClose, onToast }) {
  ...
  async function handleAdd(e) {
    ...
    if (!trimmedName) return onToast('Enter an item name.')
    if (!price || pr < 0) return onToast('Enter a valid price.')
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal modal--tall" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <p style={{ margin: 0 }}>Manage menu</p>
